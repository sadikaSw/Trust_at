      ...
      <>
        ...
        <ErrorContainer className="page">
          <h5 className="alert alert-danger">
            There was an error, please double check your Note ID.
          </h5>
  ...
  return (
    <Wrapper>
      <>
        {!user && <Navigate to="/" />}
        <header>
          <Link to="/note" className="btn btn-block back-home">
            back home
          </Link>
        </header>
        <form onSubmit={handleSubmit}>
          <p className="alert">{editComplete && "Success! Edit Complete"}</p>
          <h4>
            <u>Update Password</u>
          </h4>
